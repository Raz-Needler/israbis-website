...
export const metadata: Metadata = {
  title: "השוואת מחירי סופר בישראל 2026 — מדריך מלא | 49 רשתות",
  description: "מדריך מקיף להשוואת מחירי סופרמרקט בישראל. למה הפרשי המחירים מגיעים ל-21% בין רשתות? איך להשוות מחירי מזון בין רמי לוי, שופרסל, ויקטורי, אושר עד ועוד 45 רשתות — עם IsraBis.",
...
export default function GuideHashvaa() {
  return (
    ...
    <ArticleJsonLd
      ...
      description="מדריך מקיף להשוואת מחירי סופרמרקט בישראל בין 49 רשתות שיווק"
      url="/guides/hashvaat-mechirei-super"
      howTo={{
        name: "איך להשוות מחירי סופר בין 49 רשתות בישראל",
        ...
        step: [
          ...
          { "@type": "HowToStep", name: "ראו השוואה מלאה", text: "המערכת מחשבת את עלות העגלה בכל 49 הרשתות ומדרגת מהזולה ליקרה", position: 4 },
    ...
    <article className="sec">
      <div className="w-980" style={{ maxWidth: 760 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-7)" }}>
          ...
          <section>
            <h2 className="text-h3" style={{ marginBottom: "var(--space-3)" }}>49 רשתות שיווק — כולן במקום אחד</h2>
            <p className="text-body c-muted" style={{ lineHeight: "var(--leading-relaxed)" }}>
              IsraBis מעבדת מחירים מ-49 רשתות שיווק בישראל: רמי לוי, שופרסל, ויקטורי, טיב טעם, מחסני השוק, יוחננוף, אושר עד, חצי חינם, מגה, יינות ביתן, סטופ מרקט, קינג סטור, גוד פארם, סופר-פארם, ברקת, קשת, קופיקס, סופר ספיר, קוויק, מעיין 2000, שפע ברכת, שוק העיר, פרש מרקט, ועוד. המחירים מתעדכנים מדי יום.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-body c-muted" style={{ lineHeight: "var(--leading-relaxed)" }}>
              הוסיפו מוצרים לעגלה — מקטגוריות, ממתכונים, מסריקת ברקוד, או מסריקת קבלה. המערכת מחשבת את עלות העגלה המלאה בכל 49 הרשתות ומדרגת מהזולה ליקרה. אתם בוחרים איפה לקנות ובאמת חוסכים. לא ניחושים, לא תחושות בטן — נתונים אמיתיים.
            </p>
          </section>
