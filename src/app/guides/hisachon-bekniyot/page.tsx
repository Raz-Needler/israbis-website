    ...
    <>
      <ArticleJsonLd
        ...
        howTo={{
          ...
          totalTime: "PT10M",
          step: [
            { "@type": "HowToStep", name: "השוו מחירים בין רשתות", text: "השתמשו ב-IsraBis להשוואת מחירים בין 33 רשתות שיווק על כל מוצר", position: 1 },
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-7)" }}>
            <section>
              ...
              <p className="text-body c-muted" style={{ lineHeight: "var(--leading-relaxed)", marginTop: "var(--space-3)" }}>
                אפליקציה כמו IsraBis משווה מחירים בין 33 רשתות שיווק ומוצאת את הזולה ביותר עבור סל הקניות הספציפי שלכם. לא ממוצעים כלליים — הסל המדויק שלכם, בסניף הקרוב אליכם.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-body c-muted" style={{ lineHeight: "var(--leading-relaxed)" }}>
                במקום לרשום רשימה על נייר — בנו עגלה דיגיטלית שמשווה מחירים אוטומטית. ב-IsraBis, כל מוצר שמוסיפים מיד מחושב בכל הרשתות. כשהעגלה מוכנה — המערכת מציגה את עלות העגלה הכוללת בכל 33 הרשתות, מהזולה ליקרה.
              </p>
              <p className="text-body c-muted" style={{ lineHeight: "var(--leading-relaxed)", marginTop: "var(--space-3)" }}>
            ...
            <section>
              ...
              <p className="text-body c-muted" style={{ lineHeight: "var(--leading-relaxed)" }}>
                ראיתם מתכון ביוטיוב או בטיקטוק? הדביקו את הלינק ב-IsraBis ותקבלו תוך שניות: מתכון כתוב בעברית + רשימת מרכיבים + מחירי כל מרכיב בכל 33 הרשתות. לא עוד מתכונים שנראים מדהים אבל אז מגלים שהמרכיבים עולים ₪200.
              </p>
              <p className="text-body c-muted" style={{ lineHeight: "var(--leading-relaxed)", marginTop: "var(--space-3)" }}>
            ...
            <section>
              ...
              <p className="text-body c-muted" style={{ lineHeight: "var(--leading-relaxed)" }}>
                כל 9 הטיפים שפירטנו כאן — זמינים באפליקציה אחת, בחינם, בעברית. השוואת מחירים בין 33 רשתות, עגלה חכמה, סריקת ברקוד, סריקת מקרר AI, מתכון מסרטון, מעקב הוצאות, ניהול משפחתי, ומזווה דיגיטלית.
              </p>
              <p className="text-body c-muted" style={{ lineHeight: "var(--leading-relaxed)", marginTop: "var(--space-3)" }}>
