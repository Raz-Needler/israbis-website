      ...
      <div className="w-980" style={{ maxWidth: 760 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-7)" }}>
          ...
          <section>
            ...
            <p className="text-body c-muted" style={{ lineHeight: "var(--leading-relaxed)" }}>
              IsraBis היא אפליקציית אוכל חכמה שמחברת בין הבישול לקניות. מתכונים ללא הגבלה, כולם עם רשימת מרכיבים מתומחרת בין 33 רשתות שיווק. כלי AI שממירים סרטוני בישול למתכונים, סריקת מקרר שמציעה מתכונים ממה שיש, וסריקת קלוריות מתמונה. ומעל הכל — עגלת קניות חכמה שמוצאת את הרשת הזולה ביותר.
            </p>
          </section>
