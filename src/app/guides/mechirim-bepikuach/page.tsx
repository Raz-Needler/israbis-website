        ...
        <div className="w-980" style={{ maxWidth: 760 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-7)" }}>
            ...
            <section>
              ...
              <p className="text-body c-muted" style={{ lineHeight: "var(--leading-relaxed)" }}>
                מכיוון ש-IsraBis מקבלת מחירים עדכניים מכל 49 הרשתות בישראל — ניתן לראות בזמן אמת אם רשת כלשהי מוכרת מוצר מפוקח מעל המחיר המקסימלי המותר. זה לא תמיד קורה, אך בתקופות של עליות מחירים או שיבושים בשרשרת האספקה — לעיתים מוצרים מפוקחים נמכרים מעל הסף.
              </p>
              <p className="text-body c-muted" style={{ lineHeight: "var(--leading-relaxed)", marginTop: "var(--space-4)" }}>
            ...
            <section>
              ...
              <p className="text-body c-muted" style={{ lineHeight: "var(--leading-relaxed)", marginTop: "var(--space-4)" }}>
                החוק הוא הבסיס לקיומה של IsraBis: הנתונים שמאפשרים השוואת מחירים בין 49 רשתות מגיעים ישירות ממאגרי ה-XML שהרשתות מחויבות לפרסם. בלי החוק הזה, השוואה כזו לא הייתה אפשרית.
              </p>
              <p className="text-body c-muted" style={{ lineHeight: "var(--leading-relaxed)", marginTop: "var(--space-4)" }}>
            ...
            <section>
              ...
              <p className="text-body c-muted" style={{ lineHeight: "var(--leading-relaxed)" }}>
                IsraBis מציגה את מחירי כל המוצרים — כולל המפוקחים — בכל 49 הרשתות, בזמן אמת. בדקו כל מוצר לפי הסניף הקרוב אליכם, ראו אם המחיר עומד בגבולות הפיקוח, וגלו איפה הכי זול.
              </p>
              <p className="text-body c-muted" style={{ lineHeight: "var(--leading-relaxed)", marginTop: "var(--space-4)" }}>
                ראו גם:{" "}
