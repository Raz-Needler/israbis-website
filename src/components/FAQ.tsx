...
const ITEMS = [
  ...
  { q: "אילו רשתות נתמכות?", a: "49 רשתות שיווק כולל רמי לוי, שופרסל, ויקטורי, טיב טעם, מחסני השוק, יוחננוף, אושר עד, חצי חינם, מגה, יינות ביתן, ועוד 39 רשתות נוספות." },
  { q: "איך עובדת העגלה החכמה?", a: "מוסיפים מוצרים (מקטגוריות, ממתכונים, מסריקת ברקוד, או מסריקת קבלה), והמערכת משווה את העלות הכוללת בכל 49 הרשתות ומציגה את הזולה ביותר." },
