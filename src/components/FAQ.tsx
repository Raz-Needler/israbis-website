...
const ITEMS = [
  { q: "האם השירות חינמי?", a: "כן, IsraBis היא אפליקציה חינמית לחלוטין. בלי מנוי חובה, בלי פרסומות, בלי תשלום נסתר. תכונות פרימיום מתקדמות זמינות במנוי אופציונלי." },
  ...
  { q: "מהם כלי ה-AI?", a: "סריקת מקרר (צלמו, קבלו מתכונים), סריקת קלוריות (צלמו מנה, קבלו מידע תזונתי), מתכון מסרטון (לינק ליוטיוב/טיקטוק = מתכון מלא), סריקת קבלה (קבלה מהסופר = פריטים בעגלה), ומיקי — עוזר AI שעונה על כל שאלה." },
